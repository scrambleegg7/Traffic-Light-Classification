...
flags.DEFINE_string('yaml_path', '', 'Path to yaml file')
...
def main(_):
    ...
    INPUT_YAML = FLAGS.yaml_path
    #INPUT_YAML = "../bstld/data/test/test.yaml"
    
    print("Read YAML file", INPUT_YAML)
    print("tf record", FLAGS.output_path)
